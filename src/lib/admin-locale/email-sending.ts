...
export const EMAIL_SENDING_DICT: Record<AdminLocale, EmailSendingDictionary> = {
  es: {
    banner: {
      ...
      linkText: "Configura tu identificador en la pestaña General",
  ...
  en: {
    banner: {
      ...
      linkText: "Set up your identifier in the General tab",
  ...
  fr: {
    banner: {
      ...
      linkText: "Configurez votre identifiant dans l'onglet Général",
