...
The initial migration creates the complete garageos schema because the dashboard queries clients, invoices and reminders immediately. It does not modify the public schema. Apply to the GarageOS database only:
