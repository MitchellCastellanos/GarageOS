...
2. **Primer flujo operable.** Interfaz FR/EN, clientes, vehículos y catálogo. Criterio: cada taller configura identidad, idioma y servicios; datos sintéticos, sin copiar información del taller original.
